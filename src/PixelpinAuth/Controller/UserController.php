...
use Hybrid_Auth;
use PixelpinAuth\Mapper\Exception as MapperException;
...
class UserController extends AbstractActionController
{
    ...
    /**
     * @var \ZfcUserPixelpin\Authentication\Adapter\AdapterChain
     */
    ...
    public function providerLoginAction()
    {
        ...
        $redirectUrl = $this->url()->fromRoute('pixelpin-auth-user/authenticate/provider', array('provider' => $provider), array('query' => $query));
    ...
    public function providerAuthenticateAction()
    {
        ...
        // For provider authentication, change the auth adapter in the ZfcUserPixelpin Controller Plugin
        ...
        // Forward to the ZfcUserPixelpin Authenticate action
     ...
     *
     * @param \ZfcUserPixelpin\Authentication\Adapter\AdapterChain
     * @return UserController
     */
    public function setScnAuthAdapterChain(\ZfcUserPixelpin\Authentication\Adapter\AdapterChain $chain)
    {
     ...
     *
     * @return \ZfcUserPixelpin\Authentication\Adapter\AdapterChain
     */
    ...
    /**
     * @return \ZfcUserPixelpin\Options\ModuleOptions
     */
    ...
    /**
     * @param \ZfcUserPixelpin\Options\ModuleOptions $zfcmoduleoptions
     */
