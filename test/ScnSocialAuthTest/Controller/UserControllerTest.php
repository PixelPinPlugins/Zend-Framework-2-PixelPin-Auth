...
namespace PixelpinAuthTest\Controller;
...
class UserControllerTest extends TestCase
{
    ...
    /**
     * @var \PixelpinAuth\Controller\UserController
     */
    ...
    public function setUp()
    {
        ...
        $this->controller = new UserController(\Mockery::mock('PixelpinAuth\Controller\RedirectCallback'));
    ...
    public function testLoginProxiesToZfcUserPixelpinAndReturnsNonModelInterface()
    {
